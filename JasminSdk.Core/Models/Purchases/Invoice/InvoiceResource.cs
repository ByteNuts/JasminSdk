...
namespace ByteNuts.PrimaveraBss.JasminSdk.Core.Models.Purchases.Invoice
{
    public class InvoiceResource
    {
        ...
        /// <summary>
        /// The company code is the central organizational unit within the system.<para/>
        ...
        /// <summary>
        /// Defines the invoice's purpose. Distinguishes the business transactions to be posted. Part of the document natural key. The default invoice document type is defined in the purchases setup configuration setting.<para/>
        ...
        /// <summary>
        /// Defines the sequence to generate the series number. Part of the document natural key. The default serie is defined on the invoice document type.<para/>
        ...
        /// <summary>
        /// The supplier designated in the invoice as the party to whom the memo should be sent. It may or may not be the party from whom the goods or services are received. The default is defined on the supplier party.<para/>
        ...
        /// <summary>
        /// The supplier designated in the invoice as the party to whom the invoice is sell. It may or may not be the party from whom the goods or services are received. The default is defined on the supplier party.<para/>
        ...
        /// <summary>
        /// The financial transfer method used by the entity responsible for paying a transaction. For example, cash, transfer or check payments. The default is defined on the supplier party.<para/>
        ...
        /// <summary>
        /// The money unit used by the system, such as Euros (EUR) or United States Dollars (USD). This value is important for currency exchanges or to set the number of decimal places used to represent values. The default is defined on the supplier party.<para/>
        ...
        /// <summary>
        /// The total value of goods and services before taxes or discounts.
        /// </summary>
        ...
        /// <summary>
        /// The invoice total net value. Total value of goods and services after discounts, excluding taxes. Internally calculated.
        /// </summary>
        ...
        /// <summary>
        /// The invoice's amount. Total value of goods and services including taxes and discounts. Internally calculated.
        /// </summary>
        ...
        /// <summary>
        /// The document's total liability. Internally calculated.
        /// </summary>
        ...
        /// <summary>
        /// The document status. Internally determined.
        /// See DocumentStatus.
        /// </summary>
        ...
        /// <summary>
        /// The country of the physical location where the goods are loaded. The default is the supplier's address country.<para/>
        ...
        /// <summary>
        /// The country of the physical location where the goods are unloaded. The default is the company's address country.<para/>
        /// (fk) Allowed value: the natural key of a record of type Country. These records are accessibly through the Countries service.
        /// </summary>
        ...
        /// <summary>
        /// The alternative party address key to be used on the invoice. The alternative addresses keys are defined on the party additional addresses. When defined overrides the party address and unloading address values.<para/>
        ...
        /// <summary>
        /// Refers to a cash drawer that collects small amounts of cash in a business. On a invoice either a cash drawer or a bank account must be used to define where to debit the value. Used when the document is a cash invoice.<para/>
        ...
        /// <summary>
        /// The conditions in a sales or transportation contract that specify the means of transportation. The default is defined on the supplier party.<para/>
        ...
        /// <summary>
        /// The outgoint lot of the check used for this invoice document. Applicable only when the payment is cash payment and the payment method is of type check.<para/>
        ...
        /// <summary>
        /// The check used for this invoice. Applicable only when the payment is cash payment and the payment method is of type check.<para/>
        ...
        /// <summary>
        /// The alternative accounting party address key to be used on the invoice. The alternative addresses keys are defined on the party additional addresses. When defined overrides the accounting party address and unloading address values.<para/>
        /// (fk) Allowed value: the natural key of a record of type Address. These records are accessibly through the Addresses service.
        /// </summary>
        ...
        /// <summary>
        /// The invoice notification configuration. Inferred from the invoice type.<para/>
