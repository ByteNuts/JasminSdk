...
namespace ByteNuts.PrimaveraBss.JasminSdk.Core.Models.MasterDataBusinessEntities.Entity
{
    public class ApiPartyResource
    {
        ...
        public List<ApiPartyPartyAddressesResource> PartyAddresses { get; set; }


        [JsonProperty("partyContacts")]
        public List<ApiPartyPartyContactsResource> PartyContacts { get; set; }
