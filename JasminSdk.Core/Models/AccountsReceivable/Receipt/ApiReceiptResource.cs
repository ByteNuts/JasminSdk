...
{
    public class ApiReceiptResource
    {
        ...
        public List<ApiReceiptReceiptLinesResource> ReceiptLines { get; set; }

        /// <summary>
        /// The receipt taxes.
        /// </summary>
        [JsonProperty("receiptTaxes")]
        public List<ApiReceiptReceiptTaxesResource> ReceiptTaxes { get; set; }

        /// <summary>
        /// The receipt withholding taxes.
        /// </summary>
        [JsonProperty("receiptWTaxes")]
        public List<ApiReceiptReceiptWTaxesResource> ReceiptWTaxes { get; set; }

        /// <summary>
        /// The receipt reporting taxes lines.
        /// </summary>
        [JsonProperty("reportingLines")]
        public List<ApiReceiptReportingLinesResource> ReportingLines { get; set; }
